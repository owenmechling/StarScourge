...
def main():
    ...
    # *** Asset Loading ***
    assets = {
        "player": [pygame.image.load(f"assets/player/player{i}.png") for i in range(4)],
        "enemy0": pygame.image.load("assets/enemies/enemy0.png"),
        "enemy1": pygame.image.load("assets/enemies/enemy1.png"),
        "enemy2": pygame.image.load("assets/enemies/enemy2.png"),
        "boss": pygame.image.load("assets/enemies/boss.png"),
        "enemy_bullet": pygame.image.load("assets/projectiles/enemyBullet.png"),
        "bullet": pygame.image.load("assets/projectiles/weaponBullet.png"),
        "rocket": pygame.image.load("assets/projectiles/weaponRocket.png"),
        "shockwave": pygame.image.load("assets/projectiles/weaponShockwave.png"),
        "laserBase": pygame.image.load("assets/projectiles/weaponLaserBase.png"),
        "laserBeam": pygame.image.load("assets/projectiles/weaponLaserBeam.png"),
        "level1": pygame.image.load("assets/backgrounds/level1.png").convert(),
        "shipExplosion": pygame.image.load("assets/fx/shipExplosion.png"),
        "rocketExplosion": pygame.image.load("assets/fx/rocketExplosion.png"),
        "laserSound": pygame.mixer.Sound("assets/sounds/laserSound.mp3"),
        "rocketLaunch": pygame.mixer.Sound("assets/sounds/rocketLaunch.mp3"),
        "basicAttack": pygame.mixer.Sound("assets/sounds/basicAttack.mp3"),
        "shockwaveSound": pygame.mixer.Sound("assets/sounds/shockwaveSound.mp3"),
        "enemyDeath": pygame.mixer.Sound("assets/sounds/enemyDeath.mp3"),
        "playerDeath": pygame.mixer.Sound("assets/sounds/playerDeath.mp3"),
        "rocketDeath": pygame.mixer.Sound("assets/sounds/rocketDeath.mp3"),
        "level1music": pygame.mixer.Sound("assets/sounds/level1music.mp3")
    ...
    while running:
        ...
        # Play background music if not already playing// volume block
        assets["basicAttack"].set_volume(0.5)  # Set volume to 50%
        assets["level1music"].set_volume(0.7)  # Set volume to 70%
        if not pygame.mixer.music.get_busy():
            pygame.mixer.music.load("assets/sounds/level1music.mp3")
